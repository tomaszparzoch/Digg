...
public class DiscoveryDAOImpl implements DiscoveryDAO {
    ...
    @Override
    public Discovery create(Discovery newObjcet) {

        Discovery resultDiscovery = new Discovery(newObjcet);
        KeyHolder holder = new GeneratedKeyHolder();
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("name", newObjcet.getName());
        paramMap.put("description", newObjcet.getDescription());
        paramMap.put("url", newObjcet.getUrl());
        paramMap.put("user_id", newObjcet.getUser().getId());
        paramMap.put("date", newObjcet.getTimestamp());
        paramMap.put("up_vote", newObjcet.getUpVote());
        paramMap.put("down_vote", newObjcet.getDownVote());
